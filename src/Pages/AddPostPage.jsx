    ...
    <div className="w-full h-full">
      ...
      >
        <div className="flex items-center mb:px-3 lg:px-0">
          ...
          {window.innerWidth <= 440 && (
            <div className="relative p-3 ml-3 border border-gray-300 ">
              ...
              <div
                className={`absolute -right-5 top-12 z-50 bg-white h-screen w-[270px] pl-5 pt-3 shadow-2xl transition-transform duration-700  ${
        ...
        <div className="relative h-full">
          ...
          ></div>
          <div className="mb:overflow-x-auto lg:overscroll-x-none">
            <EditorToolbar toolbarId={"t1"} />
          </div>
          <div className="dark:bg-themeDark h-full lg:mt-[20px] flex">
            <ReactQuill
